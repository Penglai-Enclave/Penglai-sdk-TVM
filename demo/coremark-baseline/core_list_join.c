...
extern CORE_TICKS list_find;
extern CORE_TICKS list_reverse;
extern CORE_TICKS list_remove;
extern CORE_TICKS list_undo_remove;
extern CORE_TICKS list_insert_new;
extern CORE_TICKS list_mergesort;
#endif
/* local functions */
...
#if PERFORMANCE_BREAKDOWN
		stop = stop_time();
		list_insert_new += get_time(start, stop);
#endif
		return NULL;
	}
...
#if PERFORMANCE_BREAKDOWN
	stop = stop_time();
	list_remove += get_time(start, stop);
#endif
	return ret;
}
...
#if PERFORMANCE_BREAKDOWN
	stop = stop_time();
	list_undo_remove += get_time(start, stop);
#endif
	return item_removed;
}
...
#if PERFORMANCE_BREAKDOWN
	stop = stop_time();
	list_reverse += get_time(start, stop);
#endif
	return next;
}
...
#if PERFORMANCE_BREAKDOWN
			stop = stop_time();
			list_mergesort += get_time(start, stop);
#endif
            return list;
		}
